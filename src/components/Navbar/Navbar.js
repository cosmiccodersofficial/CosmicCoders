    ...
    <div>
        <nav className="bg-gradient-to-r from-teal-500 to-blue-500 shadow-lg">
            <div className="flex justify-between items-center px-6 py-4">
                <Link to="/" className="text-white font-bold text-xl ">Cosmic Coders</Link>
                <ul className="flex gap-x-10 me-5">
                  <li>
                  ...
                  <li><Link to="/ourteam" className="text-white hover:text-gray-200">Services</Link></li>
                  <li><Link to="#" className="text-white hover:text-gray-200">Contact</Link></li>
                </ul>
