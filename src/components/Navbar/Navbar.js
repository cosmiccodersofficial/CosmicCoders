    ...
    <div>
      <nav className={`fixed top-0 w-full z-10 ${visible ? 'block' : 'hidden'}`}>
        <div className="flex justify-between items-center px-6 py-2">
          <div className="cursor-pointer shadow-sm backdrop-blur-lg bg-gray-400 bg-opacity-10 rounded-full p-4 transition duration-300 lg:py-3.5 lg:px-6 hover:bg-opacity-70 text-gray-900">
            <Link to="/" className="text-gray-900 font-bold text-xl "><span className='text-blue-900'>Cosmic</span> Coders</Link>
          </div>

          <ul className="flex gap-x-10 cursor-pointer shadow-sm backdrop-blur-lg bg-gray-400 bg-opacity-10 rounded-full p-4 transition duration-300 lg:py-3.5 lg:px-6 hover:bg-opacity-70 text-gray-900 me-5">
            <li>
          ...
          <Link to="/join" className="text-white font-bold text-xl ">
            <div className="cursor-pointer border-blue-500 bg-blue-500 rounded-full p-3 lg:py-3.5 lg:px-6">
              <span className="text-white font-bold text-xl ">Join Us</span>
            </div>
          </Link>
        </div>
      </nav >
