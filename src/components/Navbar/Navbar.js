    ...
    <div>
      <nav className={`fixed top-0 w-full z-10 ${visible ? 'block' : 'hidden'}`}>
        <div className="flex justify-between items-center px-6 py-2">
          <div className="cursor-pointer hover shadow-sm backdrop-blur-lg bg-gray-400 bg-opacity-10 rounded-full p-4 transition duration-300 lg:py-3.5 lg:px-6 hover:bg-opacity-70 text-gray-900">
