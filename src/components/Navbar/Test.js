...
const NavbarComponent = () => {
  ...
  return (
    <div className={`${visible ? 'block' : 'd-none'}`}>
      <Navbar className={`fixed-top w-100 top-0 z-10 navbar`} expand="lg">
        <Container className='d-flex justify-content-between align-items-center mx-8 py-2'>
          ...
          <Navbar.Collapse id="basic-navbar-nav">
            ...
            <Nav className="cursor-pointer d-flex hover bg-gray-400 align-items-center column-gap-4 shadow nav-item p-2 mx-auto">
