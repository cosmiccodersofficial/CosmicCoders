...
const Contact = () => {
  return (
    <div className="bg-gray-50 p-8 flex flex-col items-center">
      <h2 className="text-6xl font-bold mb-6 mt-24 text-blue-900">Contact Us</h2>
      <form className="w-full max-w-md mt-12">
        {/* Name Field */}
        <div className="mb-4">
          <label htmlFor="Name" className="block text-lg font-bold mb-2 text-start">
            Name
          </label>
          <input
            type="text"
        ...
        {/* Email Field */}
        <div className="mb-4">
          <label htmlFor="email" className="block text-lg font-bold mb-2 text-start">
            Email Address
          </label>
          <input
            type="email"
        ...
        {/* Phone Number Field */}
        <div className="mb-4">
          <label htmlFor="phone" className="block text-lg font-bold mb-2 text-start">
            Phone Number
          </label>
          <input
            type="tel"
        ...
        {/* Message Field */}
        <div className="mb-4">
          <label htmlFor="message" className="block text-lg font-bold mb-2 text-start">
            Message
          </label>
          <textarea
            id="message"
